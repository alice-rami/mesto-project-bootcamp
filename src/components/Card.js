export default class Card {
    ...
    _setEventListeners() {
        ...
        this._elementLikeButton.addEventListener('click', () => this._handleLikeButton(this));
        
        if (this._isOwnCard) {
            this._elementRemoveButton.addEventListener('click', () => this._handleDeletionRequest(this._cardId, this));
        }
    }
